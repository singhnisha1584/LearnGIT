...
def evaluate_link_prediction(embedding_dict, nx_G, last_snap):
  ...
  #Create Training Data
	...
	edge_features = [
		(embedding_dict[i] + embedding_dict[j]) for i,j in all_possible_edges
	]
	...
	rfc_clf = KNeighborsClassifier(n_neighbors=7, weights='uniform', algorithm='auto', leaf_size=30, p=2, metric='minkowski', metric_params=None, n_jobs=None)
